...
export const SAMPLE_RESTAURANTS: SampleRestaurant[] = [
  {
    ...
    description:
      "Handcrafted pasta and wood-fired pizzas made with imported Italian ingredients.",
    isOpen: true,
  },
  {
    id: "r2",
    ...
    description:
      "Fresh sushi rolls and sake-marinated grilled dishes crafted daily.",
    isOpen: true,
  },
  {
    id: "r3",
    ...
    description:
      "Authentic curries and tandoori classics from Northern and Southern India.",
    isOpen: true,
  },
  {
    id: "r4",
    ...
    description:
      "Wok-fired traditional Chinese dishes, dim sum, and Peking duck.",
    isOpen: true,
  },
  {
    id: "r5",
    ...
    description:
      "Street-style tacos, burritos, and fresh guacamole made to order.",
    isOpen: true,
  },
  {
    id: "r6",
    ...
    estimatedDeliveryMinutes: 35,
    description:
      "Fragrant curries, pad thai, and fresh spring rolls from Bangkok.",
    isOpen: true,
  },
  {
    id: "r7",
    ...
    estimatedDeliveryMinutes: 40,
    description:
      "Korean BBQ, bibimbap, and spicy kimchi stews for the adventurous palate.",
    isOpen: false,
  },
  {
    id: "r8",
...
export const SAMPLE_MENU_ITEMS: Record<string, SampleMenuItem[]> = {
  r1: [
    {
      id: "m1",
      restaurantId: "r1",
...
export function useRestaurants(searchQuery?: string, cuisineFilter?: string) {
  return useQuery<SampleRestaurant[]>({
...
export function useRestaurant(id: string) {
  return useQuery<SampleRestaurant | undefined>({
...
export function useMenuItems(restaurantId: string) {
  return useQuery<SampleMenuItem[]>({
